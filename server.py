...
Handles user requests and formats emotion detection results.
'''
...
def sent_detector():
    '''Handle /emotionDetector route and return formatted emotion response'''
...
def render_index_page():
    '''Render the index.html page for the home route.'''
